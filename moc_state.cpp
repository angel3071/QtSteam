...
**
** Created: Sat Mar 2 14:56:53 2013
...
static const char qt_meta_stringdata_State[] = {
    "State\0"
};
...
const QMetaObjectExtraData State::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject State::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_State,
      qt_meta_data_State, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &State::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_State))
